...
describe('log in to app', function() {
  ...
  it('should login to app', function() {
    ...
    expect(browser.getCurrentUrl()).toEqual('https://engage-prep.sfrlabs.com/#!/dashboard');
...
describe('click on Cards link', function() {
  ...
  it('should transfer us to Cards page', function() {
    ...
    expect(browser.getCurrentUrl()).toEqual('https://engage-prep.sfrlabs.com/#!/cards');
...
describe('click on Block or replace button', function() {
  ...
  it('should block a card', function() {
