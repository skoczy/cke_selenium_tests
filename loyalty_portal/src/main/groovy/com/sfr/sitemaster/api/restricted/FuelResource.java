...
@SwaggerDefinition(
        tags = {
                @Tag(name = "fuel", description = "General information about offered fuels.")
        }
)
public class FuelResource extends SFRBaseResource {
    @Inject
    FuelService fuelService;

    @GET
    @Produces({"application/json"}) //NOPMD
    @ApiOperation(value = "Returns all fuels.",
            notes = "Returns list of fuels which are offered by sites.",
    ...
    @Path("{entity_id}")
    @Produces({"application/json"}) //NOPMD
    @ApiOperation(value = "Returns a fuel by id.", response = ServiceDTO.class)
    ...
    @ApiOperation(value = "Returns a list of fuels which are offered by a particular site.", response = ServiceDTO.class)
    public List<ServiceDTO> findBySite(@PathParam("site_id") final Long siteId) throws DBException, InvalidIdException, EntityNotFoundException, NoResultsException {
        return fuelService.getFuelsForSite(siteId);
    }
    ...
    @Produces({"application/json"}) //NOPMD
    @ApiOperation(value = "Updates a list of fuels assigned to a particular site.")
    public void update(@PathParam("site_id") final Long siteId, @PathParam("entity_id") final Long id, final List<ServiceDTO> serviceList) throws DBException, EntityNotFoundException { //NOPMD
        fuelService.save(siteId, serviceList);
    }
    ...
    @Produces({"application/json"}) //NOPMD
    @ApiOperation(value = "Updates a list of fuels assigned to a particular site.")
    public void save(@PathParam("site_id") final Long siteId, @PathParam("entity_id") final Long id, final List<ServiceDTO> serviceList) throws DBException, EntityNotFoundException { //NOPMD
        fuelService.save(siteId, serviceList);
    }
}
