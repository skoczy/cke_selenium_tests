...
describe('click on Block or replace button', function() {
		
  it('should display blocking dialog window', function() {
	
	cards.blockOrReplaceLinkClick();
...
describe('click on 1st available partner', function() {
  ...
  it('should extend the tree and show accounts', function() {
	...
	cards.blockDialog1stPartnerClick();
	browser.sleep(timeoutSlowest);
	browser.waitForAngular();
...
describe('click on 1st available account', function() {
  ...
  it('should extend the tree and show cardgroups', function() {
	...
	cards.blockDialog1stAccountClick();
	browser.sleep(timeoutSlowest1);
	browser.waitForAngular();
...
describe('click on 1st available cardgroup', function() {
  ...
  it('should extend the tree and show cards', function() {
	...
	cards.blockDialog1stCardgrpClick();
	browser.sleep(timeoutSlowest1);
	browser.waitForAngular();
...
describe('click on 1st NEXT button', function() {
		
  it('should show the window with address options', function() {
	
	cards.dialogNextButton1Click();
	browser.sleep(timeoutSlowest1);
	browser.waitForAngular();
	console.log('\n clicked on 1st NEXT button');		
  
  });
});	

describe('click on 2nd NEXT button', function() {
		
  it('should show the window with summary', function() {
	
	cards.dialogNextButton2Click();
	browser.sleep(timeoutSlowest1);
	browser.waitForAngular();
	console.log('\n clicked on 2nd NEXT button');		
...
describe('click on Send button', function() {;
  ...
  it('should unblock temporary blocked card', function() {
	...
	console.log('\n clicked on Send button');	
   	...
   	expect(element(By.xpath("/html/body/div[2]/div[2]/div[2]/section/div[3]/div[4]")).getText()).toEqual("Your request was successfully sent to the card system.");
	console.log('confirmation message has been read');						 
